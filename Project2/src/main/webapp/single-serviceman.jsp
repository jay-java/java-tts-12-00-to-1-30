...
<body>
					...
					<div class="navbar-nav ml-auto py-0">
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu rounded-0 m-0">
								<a href="customer-pending-services.jsp" class="dropdown-item">Pending</a>
								<a href="customer-approved-services.jsp" class="dropdown-item">Approved</a>
							</div>
						</div>
						<div class="nav-item dropdown">
							<a href="#" class="nav-link dropdown-toggle"
	...
	<div class="container-fluid py-5">
		<div class="container pt-5 pb-3">
			<h1 class="display-4 text-uppercase text-center mb-5">Registration</h1>
			<div class="row">
				<div class="col-lg-12 mb-2">
					...
					<div class="contact-form bg-light mb-4" style="padding: 30px;">
						<form action="BookingController" method="post">
							<input type="hidden" class="form-control p-4" name="cid" value="<%=c.getId()%>"> 
							<input type="hidden" class="form-control p-4" name="sid" value="<%=s.getId()%>">
							<div class="form-group">
								<input type="text" class="form-control p-4" name="sname"
									value="<%=s.getName()%>">
							</div>
							<div class="form-group">
								<input type="email" class="form-control p-4" name="semail"
									value="<%=s.getEmail()%>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control p-4"
									value="<%=s.getStype()%>" name="stype">
							</div>
