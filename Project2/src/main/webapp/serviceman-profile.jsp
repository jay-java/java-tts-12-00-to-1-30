					...
					<div class="navbar-nav ml-auto py-0">
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu rounded-0 m-0">
								...
								<a href="customer-login.jsp" class="dropdown-item">Change
					...
					<div class="contact-form bg-light mb-4" style="padding: 30px;">
						<form action="ServicemanController" method="post">
							<div class="form-group">
								<input type="hidden" class="form-control p-4" placeholder="Name"
							...
							<div class="form-group">
								<input type="text" class="form-control p-4"
									placeholder="Contact" name="contact" value="<%=s.getContact()%>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control p-4"
									placeholder="Address" name="address" value="<%=s.getAddress()%>">
							</div>
							<div class="form-group">
								<label for="stype"><%=s.getStype()%></label> 
								<select
									name="stype" class="form-control p-4" id="stype" >
