...
<body>
						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu rounded-0 m-0">
								<a href="serviceman-registeration.jsp" class="dropdown-item">As
									Service-Man</a> <a href="customer-registration.jsp"
	...
	<div class="container-fluid py-5">
		<div class="container pt-5 pb-3">
			<h1 class="display-4 text-uppercase text-center mb-5">Verify</h1>
			<%
			String msg  = (String)request.getAttribute("msg");
			if(msg!=null){
			%>
			<h5 class="display-4 text-uppercase text-center mb-5"><%out.print(msg); %></h5>
			<%} %>
			<div class="row">
					...
					<div class="contact-form bg-light mb-4" style="padding: 30px;">
						<form action="ServicemanController" method="post">
							<div class="form-group">
								<input type="text" class="form-control p-4" placeholder="Enter OTP"
	...
	<!-- Contact End -->
		...
		<h5 class="display-4 text-uppercase text-center mb-5"><a href="serviceman-forgot-password.jsp">Forgot Password ?</a></h5>
