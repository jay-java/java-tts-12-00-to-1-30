...
<body>
	...
	<div class="container-fluid py-5">
		<div class="container pt-5 pb-3">
			...
			<%if(msg!=null){ %>
			<h3 class="display-4 text-uppercase text-center mb-5">
				<%out.print(msg); %>
			</h3>
			<%} %>
					...
					<div class="contact-form bg-light mb-4" style="padding: 30px;">
						<form action="ServicemanController" method="post">
							<div class="form-group">
								<input type="hidden" class="form-control p-4" name="id" value="<%=s.getId()%>">
							</div>
							<div class="form-group">
								<input type="password" class="form-control p-4" placeholder="Old Password"
									required="required" name="op">
							</div>
							<div class="form-group">
								<input type="password" class="form-control p-4" placeholder="New Password"
									required="required" name="np">
							</div>
							<div class="form-group">
								<input type="password" class="form-control p-4"
									placeholder="Confirm New Password" required="required" name="cnp">
							</div>
