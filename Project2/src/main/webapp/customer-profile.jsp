					...
					<div class="contact-form bg-light mb-4" style="padding: 30px;">
						<form action="CustomerController" method="post">
							<div class="form-group">
								<input type="text" class="form-control p-4" value="<%=c.getName() %>" name="name"
									required="required">
							</div>
							<div class="form-group">
								<input type="text" class="form-control p-4"
									placeholder="Contact" name="contact" value="<%=c.getContact() %>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control p-4"
									placeholder="Address" name="address" value="<%=c.getAddress() %>">
							</div>
							<div class="form-group">
								<input type="email" class="form-control p-4" name="email" value="<%=c.getEmail() %>"
									required="required"> 
							</div>
