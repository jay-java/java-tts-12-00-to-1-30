...
%>
    ...
    <div class="container-fluid py-5">
        <div class="container pt-5 pb-3">
            <h1 class="display-4 text-uppercase text-center mb-5">Find Your Service</h1>
            <div class="row">
            ...
            <%for(ServiceMan s:list){ %>
                <div class="col-lg-4 col-md-6 mb-2">
                    <div class="rent-item mb-4">
                        ...
                        <a class="btn btn-primary px-3" href="single-serviceman.jsp?id=<%=s.getId()%>">Book Service</a>
                    </div>
                </div>
